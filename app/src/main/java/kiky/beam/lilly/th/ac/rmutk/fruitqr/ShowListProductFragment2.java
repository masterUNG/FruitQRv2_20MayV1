 ...
 */
public class ShowListProductFragment2 extends Fragment {

    private Myconstant myconstant = new Myconstant();
    private String idType, idLogin;

    public ShowListProductFragment2() {
...
//      Create RecylerView
    ...
    private void createRecylerView() {
        RecyclerView recyclerView = getView().findViewById(R.id.recyclerShowListProduct2);
        ...
        try {
            ...
            ShowListAdapter showListAdapter = new ShowListAdapter(getActivity(), nameStringArratList,
                ...
                public void onClickitem(View view, int position) {
                    ...
                    Intent intent = new Intent(getActivity(), ProductActivity2.class);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_show_list_product_2, container, false);
    }
